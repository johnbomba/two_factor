...
# pull down secret key from blockchain
client = c = mcrpc.RpcClient('127.0.0.1', 4790, 'multichainrpc', '9TymTkAXxJ4GCUy92fycCgFW5xyrkw62JpMtPeRxVbSz')
...
os.system('DECRYPT=$(echo $SECRET | xxd -p -r 9999 | openssl rsautl -decrypt -inkey ~/.multichain/2fact/stream-privkeys/1PbnmjFeTLHX8gr4HbtynmwX4Ly1Z62dXtpciA.pem)')
